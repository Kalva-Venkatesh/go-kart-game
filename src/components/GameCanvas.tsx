    ...
    <div className="relative w-full h-[850px] bg-slate-900 rounded-xl overflow-hidden shadow-2xl border-4 border-slate-700">
      ...
      <div className="absolute top-6 right-6 pointer-events-auto">
          <button
              ...
              className="bg-slate-800 hover:bg-slate-700 border border-slate-600 hover:border-slate-500 text-white p-3 rounded-lg shadow-lg transition-all duration-200 active:scale-95"
